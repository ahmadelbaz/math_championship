...
class SolveModeProvider extends ChangeNotifier {
  ...
  //     if (_gameModel.remainSeconds == 0) {
  //       _timer.cancel();
  //     } else {
  //       setRemainingSeconds(_gameModel.remainSeconds - 1);
  //       log.log('this is remaining sec ${_gameModel.remainSeconds}');
  //     }
  //   });
  //   notifyListeners();
  // }
